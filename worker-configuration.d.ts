/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e59d5437c499302cdbcb2eff5505af03)
// Runtime types generated with workerd@1.20260811.1 2025-09-06 nodejs_compat
interface __BaseEnv_Env {
	...
	EMAIL_FROM: "noreply@budget-stg.naught.ca" | "noreply@budget-uat.naught.ca" | "noreply@budget.naught.ca";
}
declare namespace Cloudflare {
	...
	interface StgEnv {
		...
		ASSETS: Fetcher;
		ENVIRONMENT: "staging";
		EMAIL_FROM: "noreply@budget-stg.naught.ca";
	}
	interface UatEnv {
		DB: D1Database;
		EMAIL: SendEmail;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EMAIL_FROM">> {}
}
